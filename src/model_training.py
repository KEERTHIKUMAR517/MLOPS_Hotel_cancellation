...
from utils.common_funtions import read_yaml,load_data
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("staring mlflow exp tracking")
                
                logger.info("logging the trainng and testing dataset")
                ...
                logger.info("Metrics are saved in MLFLOW")
